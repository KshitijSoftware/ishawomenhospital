...
<!-- Page Title -->
<title>Isha Women's Hospital: Delivering World-Class Care and Service</title>

<!-- Favicon and Touch Icons -->
<link href="images/Isha_favocon.png" rel="shortcut icon" type="image/png">
...
<div id="side-panel-container" class="dark" data-tm-bg-img="images/side-push-bg.jpg">
  <div class="side-panel-wrap">
    ...
    <img class="logo mb-50" src="images/Isha-women-1024x517.png" alt="Logo">
      ...
      <div class="tm-widget-contact-info contact-info-style1 contact-icon-theme-colored1">
        <ul>
          <li class="contact-name">
            ...
            <div class="text">Dr. Chinmay Pataki</div>
          </li>
          <li class="contact-phone">
            <div class="icon"><i class="flaticon-contact-042-phone-1"></i></div>
            <div class="text"><a href="tel:+91 98212 62953">+91 98212 62953</a></div>
          </li>
          <li class="contact-email">
            <div class="icon"><i class="flaticon-contact-043-email-1"></i></div>
            <div class="text"><a href="mailto:ishawomenshospital@gmail.com">ishawomenshospital@gmail.com</a></div>
          </li>
          <li class="contact-address">
            <div class="icon"><i class="flaticon-contact-047-location"></i></div>
            <div class="text">Ground floor, Globe Pinnacle Towers, MIDC Rd, opposite Pendharkar college Gate, Azde Gaon, Tata Power Company Limited, Dombivli East, Dombivli, Maharashtra 421203 </div>
          </li>
        </ul>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-xl-auto header-top-left align-self-center text-center text-xl-left">
            <ul class="element contact-info">
              <li class="contact-phone"><i class="fa fa-phone font-icon sm-display-block"></i> Tel: +91 79778 73974</li>
              <li class="contact-email"><i class="fa fa-envelope font-icon sm-display-block"></i> ishawomenshospital@gmail.com</li>
            </ul>
          </div>
          <div class="col-xl-auto ms-xl-auto header-top-right align-self-center text-center text-xl-right">
            <div class="element pt-0 pb-0">
              <ul class="styled-icons icon-dark icon-theme-colored1 icon-circled clearfix">
                ...
                <li><a class="social-link" target="_blank" href="https://youtube.com/@chinmaypataki?si=yc5-2iGu7E1L9ldT" target="_blank"><i class="fab fa-youtube"></i></a></li>
              </ul>
            </div>
            ...
            <div class="row header-nav-col-row">
              <div class="col-sm-auto align-self-center">
                <a class="menuzord-brand site-brand">
                  <img class="logo-default logo-3x" src="images/Isha_logo_wide.png" alt="Logo">
                </a>
              </div>
              <div class="col-sm-auto ms-auto pr-0 align-self-center">
                <nav id="top-primary-nav" class="menuzord theme-color2" data-effect="slide" data-animation="none" data-align="right">
                  <ul id="main-nav" class="menuzord-menu">
                    <li class="active menu-item">
                     ...
                     <!--     <div  class="col3">
                          ...
                          <div  class="col3">
                            <ul class="list-unstyled list-dashed">
                              <li class="menu-item">
                                <a class="tm-submenu-title" href="#"><span>All Catagory Layouts</span> <span class="badge bg-danger">New</span></a>
                                <ul class="list-unstyled">
                    ...
                    <li class="menu-item"> <a href="#">&nbsp;</a></li>
                    <li class="menu-item"> <a href="#">&nbsp;</a></li>
                    <li class="menu-item"> <a href="#">&nbsp;</a></li><!-- comment -->
                    <li class="menu-item"> <a href="#">&nbsp;</a></li>
                    <li class="menu-item"> <a href="#">&nbsp;</a></li><!-- comment -->
                    <li class="menu-item"> <a href="#">&nbsp;</a></li><!-- comment -->
                    <li class="menu-item"> <a href="#">&nbsp;</a></li><!-- comment -->
                      ...
                      <div  class="megamenu megamenu-fullwidth megamenu-position-left">
                        <div class="megamenu-row">
                          ...
                          <div  class="col3">
                            <ul class="list-unstyled list-dashed">
                              <li class="menu-item">
                                <a class="tm-submenu-title" href="#"><span>Personal Home</span> <span class="badge bg-danger">New</span></a>
                                <ul class="list-unstyled">
                          ...
                          <div class="col3">
                            <ul class="list-unstyled list-dashed">
                              <li class="menu-item">
                                <a class="tm-submenu-title" href="#"><span>Parallax Layouts</span> <span class="badge bg-danger">New</span></a>
                                <ul class="list-unstyled">
                                  ...
                                  <li class=""><a class=" tm-submenu-title" href="#"><span>Home Variations</span> <span class="badge bg-danger">New</span></a></li>
  ...
  <div class="main-content-area">
          ...
          <div class="col">
            ...
            <rs-module-wrap id="rev_slider_1_1_wrapper" data-alias="lovims-rev-slider" data-source="gallery" style="background:transparent;padding:0;margin:0px auto;margin-top:0;margin-bottom:0;">
              <rs-module id="rev_slider_1_1" style="display:none;" data-version="6.1.6">
                <rs-slides>
                  <rs-slide data-key="rs-1" data-title="Slide" data-thumb="images/pediatric/bg1.jpg" data-anim="ei:d;eo:d;s:2590;r:0;t:slidingoverlayleft;sl:d;" data-firstanim="t:slidingoverlayleft;s:1500;">
                    <img src="images/pediatric/bg1.jpg" title="rev-s4" width="1920" height="1280" data-bg="p:0% 10%;" data-parallax="12" class="rev-slidebg" data-no-retina>
                    <rs-layer
                      ...
                      style="z-index:12;background-color:#34A853;font-family:Open Sans;text-transform:uppercase;"
                    >We Provide
                    </rs-layer>
                    <rs-layer
                      ...
                      style="z-index:10; background-color:#FBBC05; font-family:Open Sans;"
                    > At Isha, One-stop for IVF, gynecologic surgery, and maternity care.
                    </rs-layer>
                    <rs-layer
                      ...
                      style="z-index:11;background-color:#4285F4;font-family:Open Sans;text-transform:uppercase;"
                    >world class healthcare for women under one roof
                    </rs-layer>
                    <rs-layer
                    ...
                    ><a href="findoutmore.php" class="btn btn-theme-colored1 btn-round btn-lg">Find Out More</a>
                    </rs-layer>
                    <rs-layer
                      ...
                      style="z-index:8;background-color:rgba(0,163,200,0.32);font-family:Roboto;"
                    >
                    </rs-layer>
                  </rs-slide>
                  <rs-slide data-key="rs-27" data-title="Slide" data-thumb="images/pediatric/bg2.jpg" data-anim="ei:d;eo:d;s:2590;r:0;t:slidingoverlayleft;sl:d;">
                    <img src="images/pediatric/bg2.jpg" title="rev-s3" width="1920" height="1280" data-bg="p:0% 10%;" data-parallax="12" class="rev-slidebg" data-no-retina>
                    <rs-layer
                      ...
                      data-frame_999="x:175%;o:1;st:w;sp:1000;sR:7300;"
                      data-frame_999_mask="u:t;x:-100%;"
                      style="z-index:12;background-color:#4285F4;font-family:Open Sans;text-transform:uppercase;"
                    >We Provide
                    </rs-layer>
                    <rs-layer
                      ...
                      data-frame_1="e:Power4.easeInOut;st:1300;sp:1000;sR:1300;"
                      data-frame_999="o:0;e:Power4.easeInOut;st:w;sp:1000;sR:6700;"
                      style="z-index:10;background-color:#34A853;font-family:Open Sans;"
                    >At ISHA, world-class fertility services are designed to assist couples on their journey toward parenthood.
                    </rs-layer>
                    <rs-layer
                      ...
                      data-frame_1="e:Power4.easeOut;st:1000;sp:1000;sR:1000;"
                      data-frame_999="sX:0.9;sY:0.9;o:0;st:w;sp:1000;sR:7000;"
                      style="z-index:11;background-color:#FBBC05;font-family:Open Sans;text-transform:uppercase;"
                    >World class fertility service at ISHA
                    </rs-layer>
                    <rs-layer
                  ...
                  <rs-slide data-key="rs-28" data-title="Slide" data-thumb="images/pediatric/bg4.jpg" data-anim="ei:d;eo:d;s:2590;r:0;t:slidingoverlayleft;sl:d;">
                    <img src="images/pediatric/bg4.jpg" title="rev-s2" width="1920" height="1280" data-bg="p:0% 10%;" data-parallax="12" class="rev-slidebg" data-no-retina>
                    <rs-layer
                      ...
                      data-frame_999="x:175%;o:1;st:w;sp:1000;sR:7300;"
                      data-frame_999_mask="u:t;x:-100%;"
                      style="z-index:12;background-color:#FBBC05;font-family:Open Sans;text-transform:uppercase;"
                    >We Provide
                    </rs-layer>
                    <rs-layer
                      ...
                      data-frame_1="e:Power4.easeInOut;st:1300;sp:1000;sR:1300;"
                      data-frame_999="o:0;e:Power4.easeInOut;st:w;sp:1000;sR:6700;"
                      style="z-index:10;background-color:#EA4335;font-family:Open Sans;"
                    >Experience our specialized male fertility services at Isha, designed to address zero sperm count and various other male fertility concerns.
                    </rs-layer>
                    <rs-layer
    ...
    <section class="position-relative z-index-1">
      <div class="container pt-0 pb-70">
        <div class="section-content section-typo-light" data-tm-margin-top="-80">
          <div class="row">
            <div class="col-lg-3">
              <div class="tm-sc-icon-box icon-box icon-top text-center iconbox-centered-in-responsive iconbox-theme-colored1 icon-position-icon-top bg-theme-colored1 mb-30 mb-sm-30 p-20 bg-white">
                <div class="icon-box-wrapper">
                  <div class="icon-wrapper">
                    <a class="icon icon-type-font-icon icon-dark icon-xl">
                      <i class="flaticon-medical-baby137 text-white font-size-72"></i>
                    </a>
                  </div>
                  <div class="icon-text">
                    <h4 class="icon-box-title"> Fertility Services for Women </h4>
                    <div class="content">
                      <p class="font-weight-500">Explore our comprehensive fertility services tailored for women, providing dedicated support and solutions to enhance reproductive health and fulfill your family planning goals.</p>
                    </div>
                    <div class="post-btn-readmore mt-30 mb-20"> <a href="#" target="_self" class="btn btn-theme-colored2 btn-sm"> Read More </a></div>
                  </div>
            ...
            <div class="col-lg-3">
              <div class="tm-sc-icon-box icon-box icon-top text-center iconbox-centered-in-responsive iconbox-theme-colored1 icon-position-icon-top bg-theme-colored1 mb-30 mb-sm-30 p-20 bg-white">
                <div class="icon-box-wrapper">
                  <div class="icon-wrapper">
                    <a class="icon icon-type-font-icon icon-dark icon-xl">
                      <i class="flaticon-medical-medical51 text-white font-size-72"></i>
                    </a>
                  </div>
                  <div class="icon-text">
                    <h4 class="icon-box-title"> Fertility Services for <br> Men </h4>
                    <div class="content">
                      <p class="font-weight-500">Explore our tailored fertility services for men at Isha. From comprehensive evaluations to specialized treatments, we offer solutions for various male fertility concerns, ensuring personalized care throughout your journey.</p>
                    </div>
                    <div class="post-btn-readmore mt-30 mb-20"> <a href="#" target="_self" class="btn btn-theme-colored2 btn-sm"> Read More </a></div>
                  </div>
                  <div class="clearfix"></div>
            ...
            <div class="col-lg-3">
              <div class="tm-sc-icon-box icon-box icon-top text-center iconbox-centered-in-responsive iconbox-theme-colored1 icon-position-icon-top bg-theme-colored1 mb-30 mb-sm-30 p-20 bg-white">
                <div class="icon-box-wrapper">
                  <div class="icon-wrapper">
                    <a class="icon icon-type-font-icon icon-dark icon-xl">
                      <i class="flaticon-medical-stethoscope10 text-white font-size-72"></i>
                    </a>
                  </div>
                  <div class="icon-text">
                    <h4 class="icon-box-title"> Laparoscopic Services at Isha </h4>
                    <div class="content">
                      <p class="font-weight-500">Explore cutting-edge laparoscopic services at Isha, where our expertise guarantees minimally invasive procedures, ensuring precision and expedited recovery. Benefit from exceptional care addressing diverse gynecologic and fertility-related concerns through our specialized laparoscopic techniques.</p>
                    </div>
                    <div class="post-btn-readmore mt-30 mb-20"> <a href="#" target="_self" class="btn btn-theme-colored2 btn-sm"> Read More </a></div>
                  </div>
                  <div class="clearfix"></div>
            ...
            <div class="col-lg-3">
              <div class="tm-sc-icon-box icon-box icon-top text-center iconbox-centered-in-responsive iconbox-theme-colored1 icon-position-icon-top bg-theme-colored1 mb-30 mb-sm-30 p-20 pt-10 bg-white">
                <div class="icon-box-wrapper">
                  <div class="icon-wrapper">
                    <a class="icon icon-type-font-icon icon-dark icon-xl mb-10">
                      <i class="fa fa-comments text-white font-size-72"></i>
                    </a>
                  </div>
                  <div class="icon-text">
                      <h4 class="icon-box-title"> Pregnancy Care at <br> Isha </h4>
                    
                    <div class="content">
                      <p class="font-weight-500">Experience top-notch pregnancy care at Isha. Our comprehensive services ensure every step of your journey is supported with expertise and compassion. From prenatal check-ups to postpartum care, we prioritize your well-being and your baby's health.</p>
                    </div>
                    <div class="post-btn-readmore mt-30 mb-20"> <a href="#" target="_self" class="btn btn-theme-colored2 btn-sm"> Read More </a></div>
                  </div>
                  <div class="clearfix"></div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-title mb-40">
              <div class="row">
                <div class="col-md-5">
                  <h2 class="mt-0">Welcome To <span class="text-theme-colored1"> Isha </span> Women's Hospital</h2>
                </div>
                <div class="col-md-7">
                  <p class="font-weight-500 mt-10">Isha Women's Hospital specializes in IVF treatments, offering advanced solutions for fertility challenges. Our expertise extends to gynecologic laparoscopic surgery, providing minimally invasive procedures for various conditions. We ensure comprehensive maternity services, catering to every aspect of prenatal care, childbirth, and postpartum support. At Isha, personalized attention, cutting-edge technology, and a compassionate approach converge to fulfill the unique needs of women at every stage of their reproductive journey.</p>
                </div>
              </div>
            </div>
              ...
              <div class="row">
                <div class="col-md-6 col-lg-6 col-xl-3">
                  <div class="tm-sc-services services-style-current-theme2">
                    <div class="tm-service">
                      <div class="thumb">
                        <img src="images/pediatric/1.jpg" alt="image">
                        <a href="#" class="icon bg-theme-colored1"><i class="flaticon-medical-dentist"></i></a>
                      </div>
                      <div class="content">
                        <h4 class="mt-0 font-20">Dental Checkup</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem autem voluptatem obcaecati!</p>
                        <div class="btn-view-details"> <a href="#" class="btn btn-theme-colored1 btn-sm"> Read more </a></div>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-lg-6 col-xl-3">
                  <div class="tm-sc-services services-style-current-theme2">
                    <div class="tm-service">
                      <div class="thumb">
                        <img src="images/pediatric/2.jpg" alt="image">
                        <a href="#" class="icon bg-theme-colored1"><i class="flaticon-medical-medicalicons"></i></a>
                      </div>
                      <div class="content">
                        <h4 class="mt-0 font-20">Growing up kids</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem autem voluptatem obcaecati!</p>
                        <div class="btn-view-details"> <a href="#" class="btn btn-theme-colored1 btn-sm"> Read more </a></div>
                      </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                  <div class="tm-sc-services services-style-current-theme2">
                    <div class="tm-service">
                      <div class="thumb">
                        <img src="images/pediatric/3.jpg" alt="image">
                        <a href="#" class="icon bg-theme-colored1"><i class="flaticon-medical-heart36"></i></a>
                      </div>
                      <div class="content">
                        <h4 class="mt-0 font-20">General Paediatrics</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem autem voluptatem obcaecati!</p>
                        <div class="btn-view-details"> <a href="#" class="btn btn-theme-colored1 btn-sm"> Read more </a></div>
                      </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                  <div class="tm-element-holder tm-fullwidth open-hours bg-theme-colored1 section-typo-light p-30">
                    <div class="tm-element-holder-wrapper">
                      <div class="tm-element-holder-content">
                        ...
                        <div class="tm-sc-button"> <a href="#" target="_self" class="btn btn-light btn-sm"> View Hospital Details </a></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="text-center mb-60">
                <div class="tm-sc-section-title section-title section-title-style1 text-center">
                  <div class="title-wrapper">
                    <h2 class="title icon-bottom"> <span class="">WHY </span> <span class="text-theme-colored1">CHOOSE</span> US</h2>
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6 col-lg-6 col-xl-4">
              <div class="tm-sc-icon-box icon-box icon-left tm-iconbox-icontype-font-icon iconbox-centered-in-responsive iconbox-theme-colored1 icon-position-icon-top mb-30 p-20">
                <div class="icon-box-wrapper">
                  <div class="icon-wrapper">
                    <a class="icon icon-type-font-icon icon-default mt-10 mr-30"><i class="flaticon-medical-first32"></i></a>
                  </div>
                  <div class="icon-text">
            ...
            <div class="col-md-6 col-lg-6 col-xl-4">
              <div class="tm-sc-icon-box icon-box icon-left tm-iconbox-icontype-font-icon iconbox-centered-in-responsive iconbox-theme-colored1 icon-position-icon-top mb-30 p-20">
                <div class="icon-box-wrapper">
                  <div class="icon-wrapper">
                    <a class="icon icon-type-font-icon icon-default mt-10 mr-30"><i class="flaticon-medical-baby137"></i></a>
                  </div>
                  <div class="icon-text">
                    <h5 class="icon-box-title">General Paediatrics</h5>
                    <div class="content">
                      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia quasi qui inventore, cumque nulla rerum consem!</p>
                    </div>
                  </div>
            ...
            <div class="col-md-6 col-lg-6 col-xl-4">
              <div class="tm-sc-icon-box icon-box icon-left tm-iconbox-icontype-font-icon iconbox-centered-in-responsive iconbox-theme-colored1 icon-position-icon-top mb-30 p-20">
                <div class="icon-box-wrapper">
                  <div class="icon-wrapper">
                    <a class="icon icon-type-font-icon icon-default mt-10 mr-30"><i class="flaticon-medical-hospitals1"></i></a>
                  </div>
                  <div class="icon-text">
                    <h5 class="icon-box-title">Operation Theatre</h5>
                    <div class="content">
                      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia quasi qui inventore, cumque nulla rerum consem!</p>
                    </div>
                  </div>
            ...
            <div class="col-md-6 col-lg-6 col-xl-4">
              <div class="tm-sc-icon-box icon-box icon-left tm-iconbox-icontype-font-icon iconbox-centered-in-responsive iconbox-theme-colored1 icon-position-icon-top mb-30 p-20">
                <div class="icon-box-wrapper">
                  <div class="icon-wrapper">
                    <a class="icon icon-type-font-icon icon-default mt-10 mr-30"><i class="flaticon-medical-blood10"></i></a>
                  </div>
                  <div class="icon-text">
            ...
            <div class="col-md-6 col-lg-6 col-xl-4">
              <div class="tm-sc-icon-box icon-box icon-left tm-iconbox-icontype-font-icon iconbox-centered-in-responsive iconbox-theme-colored1 icon-position-icon-top mb-30 p-20">
                <div class="icon-box-wrapper">
                  <div class="icon-wrapper">
                    <a class="icon icon-type-font-icon icon-default mt-10 mr-30"><i class="flaticon-medical-clipboards3"></i></a>
                  </div>
                  <div class="icon-text">
            ...
            <div class="col-md-6 col-lg-6 col-xl-4">
              <div class="tm-sc-icon-box icon-box icon-left tm-iconbox-icontype-font-icon iconbox-centered-in-responsive iconbox-theme-colored1 icon-position-icon-top mb-30 p-20">
                <div class="icon-box-wrapper">
                  <div class="icon-wrapper">
                    <a class="icon icon-type-font-icon icon-default mt-10 mr-30"><i class="flaticon-medical-pill"></i></a>
                  </div>
                  <div class="icon-text">
    ...
    <!-- Section: Team -->
    <section class="bg-img-no-repeat" data-tm-bg-img="images/photos/1.jpg">
      <div class="container">
        <div class="section-content">
          <div class="row">
            <div class="col-sm-12">
              <div class="tm-sc-staff tm-sc-staff-carousel staff-style7-medinov1 owl-dots-light-skin owl-dots-center">
                <div id="staff-holder-773890" class="owl-carousel owl-theme tm-owl-carousel-1col" data-nav="true" data-autoplay="true" data-loop="true" data-duration="6000" data-smartspeed="300" data-margin="30" data-stagepadding="0">
                  <div class="tm-carousel-item">
                    <div class="tm-staff">
                      <div class="staff-inner">
                        <div class="row align-items-center">
                          <div class="col-md-6">
                            <div class="thumb"> <img src="images/team/chinmay.jpeg" class="img-fullwidth" alt="images"/></div>
                          </div>
                          <div class="col-md-6">
                            <div class="staff-content">
                              <h5 class="degree">Dr.</h5>
                              <h3 class="name"><a href="#">Chinmay Pataki</a></h3>
                              <div class="speciality">Gynecologist, IVF Specialist, Gynec Laparoscopic Surgeon, Male Fertility Specialist</div>
                              <div class="short-bio">Dr. Chinmay Pataki is a distinguished Gynecologist, IVF Specialist, Gynec Laparoscopic Surgeon, and Male Fertility Specialist with a passion for ensuring the well-being of his patients. He is the founder and esteemed professional behind Isha Women Hospital, where his expertise and dedication converge to provide comprehensive women's health care. <br> Dr. Pataki's extensive qualifications and experience in gynecology, IVF treatments, laparoscopic surgery, and male fertility have made him a trusted figure in the field. He brings forth a unique blend of medical proficiency and compassionate care, striving to empower patients through personalized treatment plans tailored to their specific needs. <br> His commitment to excellence, coupled with a patient-centric approach, has established him as a beacon of quality healthcare. Dr. Pataki's unwavering focus on innovation and cutting-edge techniques underscores his dedication to achieving the best possible outcomes for his patients. <br> At Isha Women Hospital, Dr. Chinmay Pataki leads a team of skilled professionals dedicated to delivering exceptional healthcare services, ensuring every individual receives the highest standard of care in a supportive and nurturing environment.</div>
    ...
    <!-- Section: Divider-->
    <section class="" data-tm-bg-img="images/bg/bg8.jpg">
      <div class="container-fluid p-0">
        <div class="section-content">
          <div class="row">
            <div class="col-sm-12">
              <div class="tm-sc-custom-columns-holder tm-cc-three-columns tm-cc-responsive-mode-1024">
                <div class="tm-sc-custom-columns-holder-item" data-item-class="medinov-mascot-custom-columns-793360" data-1199-down="0 0 0 0">
                  <div class="item-inner">
                    <div class="item-content medinov-mascot-custom-columns-793360" >
                    </div>
                  </div>
                </div>
                <div class="tm-sc-custom-columns-holder-item bg-theme-colored1" data-item-class="medinov-mascot-custom-columns-484386">
                  <div class="item-inner">
                    <div class="item-content medinov-mascot-custom-columns-484386" style="padding: 7% 10% 10% 10%">
                      <h2 class="text-white mb-30 mt-0" >Our Facilities</h2>
                      <div class="tm-sc-unordered-list list-default text-white" >
                        <ul>
                          <li>Outpatient Rehabilitation</li>
                          <li>Surgery &amp; Transplants</li>
                          <li>Gynaecological Clinic</li>
                          <li>Primary Health Care</li>
                          <li>Emergancy / Critical Care</li>
                          <li>Outdoor Services</li>
                          <li>Feel like Home Services</li>
                        </ul>
                      </div>
                      <div class="tm-sc-button mt-30"><a href="#" target="_self" class="btn btn-light">Read More</a>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="tm-sc-custom-columns-holder-item" data-item-class="medinov-mascot-custom-columns-452467">
                  <div class="item-inner">
                    <div class="item-content medinov-mascot-custom-columns-452467" style="padding: 10% 10% 10% 10%">
                      <h2 class="mb-25">Reservation Form</h2>
                      <!-- Contact Form -->
      ...
      <div class="container pt-90 pb-60">
        <div class="row">
          <div class="col-md-6 col-lg-6 col-xl-3">
            <div class="tm-widget-contact-info contact-info-style1 contact-icon-theme-colored1">
              <div class="thumb">
                <img alt="Logo" src="images/Isha_logo_wide.png">
              </div>
